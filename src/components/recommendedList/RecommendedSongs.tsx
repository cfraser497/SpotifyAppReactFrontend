...
function RecommendedSongs(props: any) {
  ...
  function calculateScore(
    ...
    const tempoScore =
      tempoWeight *
      Math.min(
        Math.abs(track1.tempo - track2.tempo),
    ...
    const energyScore = Math.round(
      energyWeight * 10 * Math.abs(track1.energy - track2.energy)
    );

    return (
      maxScore - tempoScore - keyScore - genreScore - modeScore - energyScore
    );
  }
